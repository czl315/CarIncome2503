...
public class StockJob {
    ...
    private static void scheduleStock(String date) {
        ...
        new ScheduledThreadPoolExecutor(1).scheduleAtFixedRate(() -> {
            Integer countNotNullLimit = 5468;//数据已存在阈值限定5000，5222(2023.02.27),5259(2023.03.29),5468(2024.12.16)
            //查询指定日期的个数,如果低于阈值，添加。否则，数据已存在，无需新增：5222
            StockControl.addTodayStComByExistCount(date, countNotNullLimit);
