...
//            "               UP_MA_102 = '102(60)' ",
            ...
            "       </if> ",
            "       <if test='maxAdrUpSumRank1To3 != null'> ",
            "       <![CDATA[ AND ADR_UP_SUM_ORDER_1_3 <= #{maxAdrUpSumRank1To3} ]]> ",
            "       </if> ",
            "       <if test='maxAdrUpSumRank1To5 != null'> ",
            "       <![CDATA[ AND ADR_UP_SUM_ORDER_1_5 <= #{maxAdrUpSumRank1To5} ]]> ",
            "       </if> ",
