...
//            showBizSql(date, rankBizDataDiffListBiz, "bk");//显示sql-业务排行-插入
     ...
     * @return 结果
     */
    public static List<RankBizDataDiff> listEtf(int pageNo, int pageSize) {
...
//            System.out.println(JSON.toJSON(row));//每个行业一行数据
     ...
     * @return 结果
     */
    public static List<RankBizDataDiff> listBiz(String date, String type, int pageNo, int pageSize) {
...
//            System.out.println(JSON.toJSON(row));//每个行业一行数据
    ...
    public static List<RankBizDataDiff> listBiz(String date, String type, int pageSize) {
        return listBiz(date, type, 1, pageSize);
    }
