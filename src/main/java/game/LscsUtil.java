...
public class LscsUtil {
    ...
    public static void main(String[] args) {
        ...
        String page = "";
        String cardSet = "march-of-the-lich-king";//murder-at-castle-nathria;voyage-to-the-sunken-city：；united-in-stormwind   forged-in-the-barrens madness-at-the-darkmoon-faire  scholomance-academy fractured-in-alterac-valley
        String cardTye = "2212巫妖王";//  1暴风城    1贫瘠之地的锤炼  暗月马戏团   通灵学院
